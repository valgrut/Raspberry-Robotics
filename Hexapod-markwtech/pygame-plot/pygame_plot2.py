...
# Function to project 3D point to 2D screen with perspective
...
def main():
    ...
    while True:
        ...
        # Rotate the origin (O)
        line1_start = rotate_point(
            line1_start[0], line1_start[1], line1_start[2], angle1, 0, 0
        )
